...
<div class="felx flex-col items-center justify-center p-4"> 
    ...
    <div class="flex flex-col items-center space-y-4">
      <form action="/delete-question" method="POST" class="flex flex-col items-center space-y-4">
        ...
        <button  class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-redKLJ rounded-full shadow-md group">
